...
const AIThreatAnalysis: React.FC<AIThreatAnalysisProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'features' | 'timeline' | 'mitigation'>('overview');
  ...
  const FeatureImportanceBar: React.FC<{ feature: any; index: number }> = ({ feature, index }) => (
    <motion.div
    ...
    >
      <div className="flex justify-between items-center mb-1">
        ...
        <div className="flex items-center gap-2">
          <span className="text-blue-400 text-sm">{feature.value.toFixed(2)}</span>
    ...
    >
      ...
      <div className="p-4 border-b border-green-400 bg-gray-900">
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          ...
          <div className="text-center">
            <div className={`text-2xl font-bold ${getSeverityColor(threat.severity).split(' ')[0]}`}>
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div>
                <h4 className="text-green-400 font-bold mb-2">AI EXPLANATION</h4>
              ...
              <div>
                <h4 className="text-green-400 font-bold mb-2">AFFECTED ASSETS</h4>
              ...
              <div>
                <h4 className="text-green-400 font-bold mb-2">MITRE ATT&CK TECHNIQUES</h4>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-xs">
                      {new Date(threat.timestamp.getTime() - 1000).toLocaleTimeString()}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-yellow-400 text-sm">Feature Extraction</div>
                    <div className="text-gray-400 text-xs">
                      {new Date(threat.timestamp.getTime() - 500).toLocaleTimeString()}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
