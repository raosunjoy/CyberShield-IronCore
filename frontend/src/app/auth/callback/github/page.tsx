...
export default function GitHubCallbackPage() {
  ...
  const [message, setMessage] = useState('Processing GitHub Enterprise authentication...');
  ...
  useEffect(() => {
    const processCallback = async () => {
      try {
        ...
        setStatus('success');
        setMessage('GitHub Enterprise authentication successful! Redirecting to dashboard...');
